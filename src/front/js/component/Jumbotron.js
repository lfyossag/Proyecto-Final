...
const Jumbotron = () => {
  return (
    <div className="container-md">
      <div className="row" >
        <div className="img-0 col position-relative"> {/* img man */}
            <img
              src="https://www.reiss.com/nxtcms/resource/blob/4617558/257c5647d38454b19936a05555e21b51/01-02-22-ol-mw-min-2-data.jpg"
              className="card-img-top"
              alt="..."
            />
            <button type="button" className="buttonMen btn btn-dark position-absolute top-50 start-50 translate-middle">
              SHOP MENS
            </button>
        </div>
        <div className="img-1 col position-relative"> {/* img woman */}
            <img
              src="https://www.reiss.com/nxtcms/resource/blob/4617560/a35398d954f1bfdc012fbf87094c41b4/01-02-22-ol-ww-min-2-data.jpg"
              className="card-img-top"
              alt="..."
            />
             <button type="button" className="buttonWomen btn btn-dark position-absolute top-50 start-50 translate-middle">
              SHOP WOMENS
            </button>
        </div>
      </div>

      <div className="row "> {/* img man */}
        ...
        <div className="img-3 col-3 text-center"> {/* img man */}
          <img
        ...
        <div className="img-4 col-3  text-center"> {/* img woman */}
          <img
        ...
        <div className="img-5 col-3 text-center"> {/* img man */}
          <img
